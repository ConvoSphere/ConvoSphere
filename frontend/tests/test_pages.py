                        ...
                        with ui.column().classes("chat-messages"):
                            ...
                            for msg in messages:
                                with ui.card().classes(
                                    f"message-bubble {msg['type']}-message",
                                ):
                                    ui.label(msg["content"])

                        # Chat input
                        with ui.row().classes("chat-input"):
                            message_input = ui.textarea("Type your message...").classes(
                                "flex-1",
                            )
            ...
            with ui.page("/assistants"):
                with ui.column().classes("assistants-page"):
                    ...
                    with ui.grid(columns=3).classes("assistants-grid"):
                        ...
                        for assistant in assistants:
                            with ui.card().classes("assistant-card"):
                                ui.avatar("AI")
                                ui.label(assistant["name"]).classes(
                                    "text-lg font-medium",
                                )
                                ui.label(assistant["description"]).classes(
                                    "text-gray-600",
                                )
                                ui.badge(
                                    assistant["status"],
                    ...
                    with ui.dialog() as create_dialog:
                        with ui.card():
                            ui.label("Create New Assistant").classes(
                    ...
                    with ui.grid(columns=4).classes("documents-grid"):
                        ...
                        for doc in documents:
                            with ui.card().classes("document-card"):
                                ...
                                ui.label(f"{doc['type']} • {doc['size']}").classes(
                                    "text-gray-600 text-sm",
                                )
                    ...
                    with ui.dialog() as upload_dialog:
                        with ui.card():
                            ...
                            with ui.column().classes("upload-area"):
                                ...
                                ui.label("Drag and drop files here").classes(
                                    "text-gray-600",
                                )
                    ...
                    with ui.dialog() as add_tool_dialog:
                        with ui.card():
                            ...
                            category_select = ui.select(
                                "Category", options=["Search", "File", "Utility", "API"],
                            )
                ...
                with ui.column().classes("settings-page"):
                    ...
                    with ui.tab_panels(tabs, value="Account"):
                        ...
                        with ui.tab_panel("Appearance"):
                            with ui.card():
                                ui.label("Appearance Settings").classes(
                                    "text-lg font-medium mb-4",
                                )
                        ...
                        with ui.tab_panel("Notifications"):
                            with ui.card():
                                ui.label("Notification Settings").classes(
                                    "text-lg font-medium mb-4",
                                )

                                email_notifications = ui.checkbox(
                                    "Email notifications", value=True,
                                )
                                push_notifications = ui.checkbox(
                                    "Push notifications", value=True,
                                )
                                sound_notifications = ui.checkbox(
                                    "Sound notifications", value=False,
                                )
                        ...
                        with ui.tab_panel("Security"):
                            with ui.card():
                                ui.label("Security Settings").classes(
                                    "text-lg font-medium mb-4",
                                )
                ...
                with ui.column().classes("admin-page"):
                    ...
                    with ui.tab_panels(tabs, value="Users"):
                        ...
                        with ui.tab_panel("Analytics"):
                            with ui.card():
                                ui.label("System Analytics").classes(
                                    "text-lg font-medium mb-4",
                                )
                                ...
                                with ui.grid(columns=4).classes("analytics-grid"):
                                    ...
                                    for stat in analytics:
                                        with ui.card().classes("analytics-card"):
                                            ui.icon(stat["icon"]).classes(
                                                "text-blue-500",
                                            )
                                            ui.label(stat["value"]).classes(
                                                "text-2xl font-bold",
                                            )
                                            ui.label(stat["title"]).classes(
                                                "text-gray-600",
                                            )
            ...
            with ui.page("/responsive-test"):
                with ui.column().classes("responsive-page"):
                    ...
                    with ui.row().classes("responsive-header"):
                        ui.label("Responsive Page").classes(
        ...
        with TestClient() as client:
            ...
            with ui.page("/404"):
                with ui.column().classes("error-page"):
                    ...
                    ui.label("The page you're looking for doesn't exist.").classes(
                        "text-gray-600",
                    )
        ...
        with TestClient() as client:
            ...
            with ui.page("/500"):
                with ui.column().classes("error-page"):
                    ...
                    ui.label("Something went wrong on our end.").classes(
                        "text-gray-600",
                    )
