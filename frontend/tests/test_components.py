            ...
            with ui.dialog() as dialog:
                with ui.card():
                    ...
                    with ui.column().classes("parameters"):
                        param_input = ui.input("Parameter", placeholder="Enter parameter value")
                        param_select = ui.select("Type", options=["String", "Number", "Boolean"])
    ...
    def test_error_message_creation(self):
        ...
        with TestClient() as client:
            ...
            with ui.card().classes("error-message"):
                ...
                error_description = ui.label("Something went wrong").classes("text-red-600")
            ...
            with ui.dialog() as dialog:
                with ui.card():
                    ...
                    with ui.column():
                        ...
                        description_input = ui.textarea("Description", placeholder="Enter description")
