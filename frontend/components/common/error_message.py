...
class ErrorMessage:
    ...
    def _get_dismiss_classes(self) -> str:
        ...
        return dismiss_classes.get(
            self.severity, "bg-red-50 text-red-500 hover:bg-red-100",
        )
    ...
    def update_message(self, message: str, severity: ErrorSeverity | None = None):
