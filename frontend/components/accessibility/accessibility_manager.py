...
class AccessibilityManager:
    ...
    def add_skip_link(self, target_id: str, text: str):
        ...
        ui.link(text, f"#{target_id}").classes("skip-link").props(
            f"id={skip_link['id']}",
        )
    ...
    def add_aria_live_regions(self):
        ...
        for region_id, politeness in live_regions.items():
            ...
            ui.element("div").props(f"aria-live={politeness} id={region_id}").classes(
                "sr-only",
            )
    ...
    def register_focusable_element(self, element_id: str, order: int | None = None):
    ...
    def add_semantic_landmark(
        self, landmark_type: str, element_id: str, label: str = "",
    ):
    ...
    def create_accessible_button(
        self, text: str, icon: str = "", on_click=None, **kwargs,
    ):
    ...
    def create_accessible_table(
        self, headers: list[str], data: list[list[str]], **kwargs,
    ):
