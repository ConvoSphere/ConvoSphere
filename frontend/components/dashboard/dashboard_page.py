...
class DashboardPage:
    ...
    def _create_welcome_section(self):
        ...
        with ui.element("div").classes(
            ...
            with ui.element("div").classes("flex items-center justify-between"):
                with ui.element("div"):
                    ui.html(
                        "<h1 style='font-size: 24px; font-weight: 700; color: var(--color-text); margin-bottom: 4px;'>Willkommen zu ConvoSphere</h1>",
                    )
                    ui.html(
                        "<p style='color: var(--color-text-secondary); font-size: 16px;'>Deine AI Assistant Platform</p>",
                    )

                with ui.element("div").classes("text-right"):
                    ui.html(
                        "<p style='color: var(--color-text-secondary); font-size: 14px;'>Letzter Login</p>",
                    )
                    ui.html(
                        "<p style='color: var(--color-text); font-size: 16px; font-weight: 600;'>Heute, 09:30</p>",
                    )
    ...
    def _create_stat_card(
        ...
        with ui.element("div").classes(
            f"bg-white dark:bg-gray-800 rounded-lg shadow-sm border {color_classes[color]} p-6",
        ):
            with ui.element("div").classes("flex items-center justify-between"):
                with ui.element("div"):
                    ui.html(
                        f"<p style='color: var(--color-text-secondary); font-size: 14px; margin-bottom: 4px;'>{title}</p>",
                    )
                    ui.html(
                        f"<p style='font-size: 32px; font-weight: 700; color: var(--color-text); margin-bottom: 4px;'>{value}</p>",
                    )
                    ui.html(
                        f"<p style='font-size: 14px; {change_color};'>{change} vs. letzter Monat</p>",
                    )

                with ui.element("div").classes(
                    f"p-3 rounded-full bg-{color}-100 dark:bg-{color}-900/30",
                ):
                    ui.icon(icon).classes(
                        f"h-6 w-6 text-{color}-600 dark:text-{color}-400",
                    )
    ...
    def _create_quick_actions_section(self):
        ...
        with ui.element("div").classes(
            ...
            ui.html(
                "<h2 style='font-size: 20px; font-weight: 600; color: var(--color-text); margin-bottom: 6px;'>Schnellaktionen</h2>",
            )
            ui.html(
                "<p style='color: var(--color-text-secondary); font-size: 14px; margin-bottom: 6px;'>Häufig verwendete Funktionen</p>",
            )
    ...
    def _create_quick_action_button(
        self, title: str, icon: str, description: str, on_click,
    ):
        ...
        with ui.element("div").classes("group"):
            with ui.button(
                ...
                "w-full p-4 text-left bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 rounded-lg border border-gray-200 dark:border-gray-600 transition-colors",
            ):
                with ui.element("div").classes("flex items-center space-x-3"):
                    ui.icon(icon).classes("h-5 w-5 text-gray-600 dark:text-gray-400")
                    with ui.element("div"):
                        ui.html(
                            f"<p style='font-size: 14px; font-weight: 600; color: var(--color-text); margin-bottom: 2px;'>{title}</p>",
                        )
                        ui.html(
                            f"<p style='font-size: 12px; color: var(--color-text-secondary);'>{description}</p>",
                        )
    ...
    def _create_recent_activity_section(self):
        ...
        with ui.element("div").classes(
            ...
            ui.html(
                "<h2 style='font-size: 20px; font-weight: 600; color: var(--color-text); margin-bottom: 6px;'>Letzte Aktivitäten</h2>",
            )
            ui.html(
                "<p style='color: var(--color-text-secondary); font-size: 14px; margin-bottom: 6px;'>Übersicht der letzten Aktionen</p>",
            )
    ...
    def _create_activity_item(
        self, title: str, description: str, time: str, icon: str, color: str,
    ):
        ...
        with ui.element("div").classes(
            "flex items-start space-x-3 p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors",
        ):
            ...
            with ui.element("div").classes("flex-1 min-w-0"):
                ...
                ui.html(
                    f"<p style='font-size: 13px; color: var(--color-text-secondary); margin-bottom: 2px;'>{description}</p>",
                )
                ui.html(
                    f"<p style='font-size: 12px; color: var(--color-text-secondary);'>{time}</p>",
                )
    ...
    def _create_system_status_section(self):
        ...
        with ui.element("div").classes(
            ...
            ui.html(
                "<h2 style='font-size: 20px; font-weight: 600; color: var(--color-text); margin-bottom: 6px;'>System Status</h2>",
            )
            ui.html(
                "<p style='color: var(--color-text-secondary); font-size: 14px; margin-bottom: 6px;'>Aktuelle System-Informationen</p>",
            )
            ...
            with ui.element("div").classes(
                ...
                # Backend Status
                with ui.element("div").classes(
                    "flex items-center justify-between p-3 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-700",
                ):
                    with ui.element("div").classes("flex items-center space-x-3"):
                        ...
                        with ui.element("div"):
                            ui.html(
                                "<p style='font-size: 14px; font-weight: 600; color: var(--color-text);'>Backend API</p>",
                            )
                            ui.html(
                                "<p style='font-size: 12px; color: var(--color-text-secondary);'>Online</p>",
                            )
                ...
                with ui.element("div").classes(
                    ...
                    with ui.element("div").classes("flex items-center space-x-3"):
                        ...
                        with ui.element("div"):
                            ui.html(
                                "<p style='font-size: 14px; font-weight: 600; color: var(--color-text);'>Datenbank</p>",
                            )
                            ui.html(
                                "<p style='font-size: 12px; color: var(--color-text-secondary);'>Verbunden</p>",
                            )
                ...
                with ui.element("div").classes(
                    ...
                    with ui.element("div").classes("flex items-center space-x-3"):
                        ...
                        with ui.element("div"):
                            ui.html(
                                "<p style='font-size: 14px; font-weight: 600; color: var(--color-text);'>Vector DB</p>",
                            )
                            ui.html(
                                "<p style='font-size: 12px; color: var(--color-text-secondary);'>Aktiv</p>",
                            )
                ...
                with ui.element("div").classes(
                    ...
                    with ui.element("div").classes("flex items-center space-x-3"):
                        ...
                        with ui.element("div"):
                            ui.html(
                                "<p style='font-size: 14px; font-weight: 600; color: var(--color-text);'>Cache</p>",
                            )
                            ui.html(
                                "<p style='font-size: 12px; color: var(--color-text-secondary);'>Verfügbar</p>",
                            )
    ...
    def _handle_new_conversation(self):
        ...
        try:
            ...
            ui.notify(
                f"Fehler beim Navigieren zur Chat-Seite: {str(e)}", type="negative",
            )
    ...
    def _handle_create_assistant(self):
        ...
        try:
            ...
            ui.notify(
                f"Fehler beim Navigieren zur Assistenten-Seite: {str(e)}",
                type="negative",
            )
    ...
    def _handle_upload_document(self):
        ...
        try:
            ...
            ui.notify(
                f"Fehler beim Navigieren zur Knowledge-Base-Seite: {str(e)}",
                type="negative",
            )
    ...
    def _handle_add_tool(self):
        ...
        try:
            ...
            ui.notify(
                f"Fehler beim Navigieren zur Tools-Seite: {str(e)}", type="negative",
            )
    ...
    async def load_dashboard_data(self):
        ...
        try:
            ...
            ui.notify(
                f"Fehler beim Laden der Dashboard-Daten: {str(e)}", type="negative",
            )
            # Set fallback values
            self.stats = {
                "total_conversations": 0,
