        ...
        with ui.element("div").classes(
            ...
            with ui.card().classes("w-full max-w-md p-8 shadow-xl"):
                ...
                with ui.element("div").classes("text-center mb-8"):
                    ui.html(
                        "<h1 style='font-size: 28px; font-weight: 700; color: #1f2937; margin-bottom: 8px;'>Konto erstellen</h1>",
                    )
                    ui.html(
                        "<p style='color: #6b7280; font-size: 16px;'>Erstelle dein neues Konto</p>",
                    )
                ...
                with ui.element("form").classes("space-y-6"):
                    ...
                    with ui.element("div").classes("flex items-start"):
                        self.terms_checkbox = ui.checkbox(
                    ...
                    self.register_button = ui.button(
                        ...
                        "w-full bg-green-600 text-white py-2 px-4 rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-colors",
                    )
