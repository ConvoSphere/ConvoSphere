        ...
        with ui.element("div").classes(
            ...
            with ui.card().classes("w-full max-w-md p-8 shadow-xl"):
                ...
                with ui.element("div").classes("text-center mb-8"):
                    ui.html(
                        "<h1 style='font-size: 28px; font-weight: 700; color: #1f2937; margin-bottom: 8px;'>Willkommen zurück</h1>",
                    )
                    ui.html(
                        "<p style='color: #6b7280; font-size: 16px;'>Melde dich in deinem Konto an</p>",
                    )
                ...
                with ui.element("form").classes("space-y-6"):
                    ...
                    with ui.row().classes("flex items-center justify-between"):
                        ui.checkbox("Angemeldet bleiben").classes(
