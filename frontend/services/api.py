...
class APIClient:
    ...
    async def update_assistant(
        ...
        """Update assistant."""
        return await self._make_request(
            "PUT", f"/api/v1/assistants/{assistant_id}", assistant_data,
        )
    ...
    async def get_document(self, document_id: str) -> APIResponse:
        ...
        return await self._make_request(
            "GET", f"/api/v1/knowledge/documents/{document_id}",
        )

    async def upload_document(
        self, file_data: dict[str, Any], metadata: dict[str, Any],
    ) -> APIResponse:
        """Upload document."""
        return await self._make_request(
            "POST",
    ...
    async def delete_document(self, document_id: str) -> APIResponse:
        """Delete document."""
        return await self._make_request(
            "DELETE", f"/api/v1/knowledge/documents/{document_id}",
        )

    async def download_document(self, document_id: str) -> APIResponse:
        """Download document."""
        return await self._make_request(
            "GET", f"/api/v1/knowledge/documents/{document_id}/download",
        )

    async def process_document(self, document_id: str) -> APIResponse:
        """Process document."""
        return await self._make_request(
            "POST", f"/api/v1/knowledge/documents/{document_id}/process",
        )
    ...
    async def search_conversations(
        self, query: str, conversation_id: str | None = None, limit: int = 10,
    ) -> APIResponse:
        ...
        return await self._make_request(
            "GET", "/api/v1/search/conversations", params=params,
        )
