...
class KnowledgeService:
    ...
    async def get_documents(self, force_refresh: bool = False) -> List[Document]:
        ...
        try:
            ...
            if response.success and response.data:
                self.documents = [self._create_document_from_data(doc_data) for doc_data in response.data]
            else:
    ...
    async def update_document(self, document_id: str, document_data: Dict[str, Any]) -> Optional[Document]:
        """
    ...
    async def search_documents(
        ...
        try:
            ...
            if response.success and response.data:
                self.search_results = [self._create_search_result_from_data(result_data) for result_data in response.data]
    ...
    async def get_document_chunks(self, document_id: str) -> List[DocumentChunk]:
        ...
        try:
            ...
            if response.success and response.data:
                return [self._create_chunk_from_data(chunk_data) for chunk_data in response.data]
            else:
    ...
    def _create_document_from_data(self, data: Dict[str, Any]) -> Document:
        ...
        chunks = None
        if data.get("chunks"):
            chunks = [self._create_chunk_from_data(chunk_data) for chunk_data in data["chunks"]]
