...
class ToolService:
    ...
    async def create_tool(self, tool_data: Dict[str, Any]) -> Optional[Tool]:
        """
        Create new tool.
    ...
    async def update_tool(self, tool_id: str, tool_data: Dict[str, Any]) -> Optional[Tool]:
        """
        Update tool.
    ...
    async def execute_tool(
        ...
        try:
            ...
            if not validation_result["valid"]:
                raise ValueError(f"Tool input validation failed: {validation_result['errors']}")
    ...
    async def _execute_regular_tool(self, tool: Tool, input_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _execute_mcp_tool(self, tool: Tool, input_data: Dict[str, Any]) -> Dict[str, Any]:
        """Execute an MCP tool."""
        try:
    ...
    def _validate_tool_input(self, tool: Tool, input_data: Dict[str, Any]) -> Dict[str, Any]:
        """
        ...
        for param in tool.parameters:
            ...
            if param.enum and value not in param.enum:
                errors.append(f"Parameter '{param_name}' must be one of: {', '.join(param.enum)}")
    ...
    def get_tool_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "recent_executions": len([r for r in self.execution_history if r.execution_time > 0])
        }
    ...
    def _create_tool_from_data(self, data: Dict[str, Any], tool_type: ToolType = ToolType.FUNCTION) -> Tool:
        """
