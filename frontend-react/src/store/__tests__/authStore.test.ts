...
describe('AuthStore', () => {
  ...
  describe('Login', () => {
    ...
    test('should set loading state during login', async () => {
      jest.mocked(authService.login).mockImplementation(
  ...
  describe('Register', () => {
    ...
    test('should handle registration error', async () => {
      ...
      jest.mocked(authService.register).mockRejectedValue(new Error(errorMessage));
  ...
  describe('Logout', () => {
    ...
    test('should handle logout error gracefully', async () => {
      jest.mocked(authService.logout).mockRejectedValue(new Error('Network error'));
  ...
  describe('Token Management', () => {
    test('should refresh token successfully', async () => {
      ...
      jest.mocked(authService.refreshToken).mockResolvedValue({ token: newToken });
    ...
    test('should handle token refresh error', async () => {
      jest.mocked(authService.refreshToken).mockRejectedValue(new Error('Token expired'));
  ...
  describe('User Management', () => {
    ...
    test('should handle profile update error', async () => {
      jest.mocked(authService.updateProfile).mockRejectedValue(new Error('Update failed'));
