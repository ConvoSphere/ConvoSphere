    ...
    switch (type) {
      ...
      case "knowledge_update":
        if (this.knowledgeUpdateHandler && messageData.documents) {
          this.knowledgeUpdateHandler(
            messageData.documents,
    ...
    setTimeout(() => {
      if (this.messageHandler) {
        this.connect(
          ...
          conversationId,
          this.messageHandler,
          this.knowledgeUpdateHandler || undefined,
          this.processingJobHandler || undefined,
        );
      }
    }, delay);
  }
