...
describe("ResetPassword", () => {
  ...
  it("shows invalid token state when token is invalid", async () => {
    ...
    await waitFor(() => {
      ...
      expect(screen.getByText("Token abgelaufen oder ungültig")).toBeInTheDocument();
  ...
  it("renders reset password form when token is valid", async () => {
    ...
    await waitFor(() => {
      ...
      expect(screen.getByPlaceholderText("Ihr neues Passwort")).toBeInTheDocument();
      expect(screen.getByPlaceholderText("Bestätigen Sie Ihr neues Passwort")).toBeInTheDocument();
    });
  });
  ...
  it("handles successful password reset", async () => {
    ...
    const confirmPasswordInput = screen.getByPlaceholderText("Bestätigen Sie Ihr neues Passwort");
    ...
    await waitFor(() => {
      ...
      expect(screen.getByText("Passwort-Reset erfolgreich")).toBeInTheDocument();
      expect(screen.getByText("Ihr Passwort wurde erfolgreich zurückgesetzt. Sie können sich jetzt mit Ihrem neuen Passwort anmelden.")).toBeInTheDocument();
    });
  });
