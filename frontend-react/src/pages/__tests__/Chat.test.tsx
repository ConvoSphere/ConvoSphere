...
describe('Chat', () => {
  ...
  test('shows loading state while sending message', async () => {
    const mockAddMessage = jest.fn().mockImplementation(() => new Promise(resolve => setTimeout(resolve, 100)));
  ...
  test('handles message sending error', async () => {
    const mockAddMessage = jest.fn().mockRejectedValue(new Error('Failed to send message'));
