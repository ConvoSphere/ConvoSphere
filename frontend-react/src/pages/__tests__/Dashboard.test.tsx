...
describe('Dashboard Component', () => {
  ...
  describe('Rendering', () => {
    ...
    it('shows loading state initially', () => {
      ...
      const loadingCards = screen.getAllByRole('generic').filter(el => 
        el.className.includes('ant-card-loading')
      );
  ...
  describe('Statistics Cards', () => {
    it('displays conversation statistics', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText('dashboard.stats.conversations')).toBeInTheDocument();
    ...
    it('displays message statistics', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText('dashboard.stats.messages')).toBeInTheDocument();
    ...
    it('displays document statistics', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText('dashboard.stats.documents')).toBeInTheDocument();
    ...
    it('displays assistant statistics', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText('dashboard.stats.assistants')).toBeInTheDocument();
  ...
  describe('System Health Section', () => {
    ...
    it('displays active users count', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText('dashboard.stats.active_users')).toBeInTheDocument();
  ...
  describe('Quick Actions', () => {
    ...
    it('renders start chat quick action', async () => {
      ...
      await waitFor(() => {
        const startChatButton = screen.getByText('dashboard.quick_actions.start_chat');
    ...
    it('renders upload document quick action', async () => {
      ...
      await waitFor(() => {
        const uploadButton = screen.getByText('dashboard.quick_actions.upload_document');
    ...
    it('renders manage assistants quick action', async () => {
      ...
      await waitFor(() => {
        const assistantsButton = screen.getByText('dashboard.quick_actions.manage_assistants');
    ...
    it('renders view tools quick action', async () => {
      ...
      await waitFor(() => {
        const toolsButton = screen.getByText('dashboard.quick_actions.view_tools');
  ...
  describe('Recent Activity', () => {
    ...
    it('displays activity items', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText('Neue Konversation gestartet')).toBeInTheDocument();
        expect(screen.getByText('Dokument hochgeladen: Projektplan.pdf')).toBeInTheDocument();
        expect(screen.getByText('Assistent "Support Bot" erstellt')).toBeInTheDocument();
        expect(screen.getByText('MCP Tool "Weather API" hinzugefügt')).toBeInTheDocument();
      });
    });
  ...
  describe('Admin Section', () => {
    ...
    it('does not show admin section for regular users', async () => {
      ...
      await waitFor(() => {
        expect(screen.queryByText('dashboard.admin_section')).not.toBeInTheDocument();
      });
    });
    ...
    it('displays admin statistics for admin users', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText('dashboard.admin.total_users')).toBeInTheDocument();
        expect(screen.getByText('dashboard.admin.system_load')).toBeInTheDocument();
  ...
  describe('Responsive Design', () => {
    it('renders with responsive grid layout', async () => {
      ...
      await waitFor(() => {
        ...
        const gridContainer = screen.getByText('dashboard.stats.conversations').closest('.ant-col');
    ...
    it('applies theme colors correctly', async () => {
      ...
      await waitFor(() => {
        ...
        const statCards = screen.getAllByRole('generic').filter(el => 
          el.className.includes('ant-statistic')
        );
