    ...
    },
    {
      ...
      render: (role: string, record: User) => (
        <ModernSelect
          ...
          style={{ width: 140 }}
        >
          <ModernSelect.Option value="user">
            {t("admin.roles.user", "Benutzer")}
          </ModernSelect.Option>
          <ModernSelect.Option value="moderator">
            {t("admin.roles.moderator", "Moderator")}
          </ModernSelect.Option>
          <ModernSelect.Option value="admin">
            {t("admin.roles.admin", "Administrator")}
          </ModernSelect.Option>
          <ModernSelect.Option value="super_admin">
            {t("admin.roles.super_admin", "Super Admin")}
          </ModernSelect.Option>
        </ModernSelect>
      ),
    },
      ...
      render: (status: string, record: User) => (
        ...
        >
          <ModernSelect.Option value="active">
            {t("admin.status.active", "Aktiv")}
          </ModernSelect.Option>
          <ModernSelect.Option value="inactive">
            {t("admin.status.inactive", "Inaktiv")}
          </ModernSelect.Option>
          <ModernSelect.Option value="suspended">
            {t("admin.status.suspended", "Gesperrt")}
          </ModernSelect.Option>
        </ModernSelect>
      ),
    },
    {
      ...
      render: (timestamp: string) => (
        <div>
          ...
          <Text type="secondary" style={{ fontSize: "12px" }}>
            {timestamp
              ? t("admin.users.login_count", "{{count}} Logins", { count: 0 })
              : ""}
          </Text>
        </div>
      ),
                      ...
                      >
                        <div>
                          ...
                          <Progress
                            ...
                            status={
                              systemStats?.cpuUsage && systemStats.cpuUsage > 80
                                ? "exception"
                                : "active"
                            }
                      ...
                      >
                        ...
                        >
                          <div>
                            ...
                            <Text type="secondary">
                              {t(
                                "admin.config.maintenance_mode_desc",
                        ...
                        >
                          <div>
                            <Text strong style={{ fontSize: "16px" }}>
                              {t(
                                "admin.config.enable_registration",
                                "Registrierung",
                              )}
                            </Text>
                            <br />
                            <Text type="secondary">
                              {t(
                                "admin.config.enable_registration_desc",
                                "Neue Benutzerregistrierung erlauben",
                              )}
                            </Text>
                          </div>
                          <Switch
                ...
                <ModernCard variant="elevated" size="md">
                  ...
                  >
                    <div>
                      ...
                      <Text type="secondary">
                        {t(
                          "admin.audit_log_desc",
                          "Überwachung aller Systemaktivitäten",
                        )}
                      </Text>
                    </div>
                    <Space>
        ...
        <Modal
          title={
            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
              <UserOutlined style={{ color: colors.colorPrimary }} />
              {editingUser
                ? t("admin.edit_user", "Benutzer bearbeiten")
                : t("admin.add_user", "Benutzer hinzufügen")}
            </div>
          }
          ...
          style={{ top: 20 }}
        >
          <ModernForm form={form} layout="vertical" onFinish={handleUserSave}>
            <Row gutter={[16, 16]}>
              <Col span={12}>
                <ModernFormItem
                  name="username"
                ...
                >
                  <ModernInput
                    ...
                    placeholder={t(
                      "admin.users.username_placeholder",
              ...
              <Col span={12}>
                ...
                >
                  <ModernInput
                    prefix={
                      <MailOutlined style={{ color: colors.colorSecondary }} />
                    }
                    placeholder={t(
                      "admin.users.email_placeholder",
                      "E-Mail eingeben",
                    )}
                  />
                </ModernFormItem>
            ...
            <Row gutter={[16, 16]}>
              ...
              <Col span={12}>
                ...
                >
                  <ModernSelect
                    placeholder={t(
                      "admin.users.status_placeholder",
                      "Status auswählen",
                    )}
                  >
                    <ModernSelect.Option value="active">
