...
const DocumentList: React.FC<DocumentListProps> = ({
  ...
  const columns = [
    ...
    },
    {
      ...
      onFilter: (value: string, record: Document) => record.document_type === value,
    },
    {
      title: 'Author',
      dataIndex: 'author',
      ...
      sorter: (a: Document, b: Document) => (a.author || '').localeCompare(b.author || ''),
    },
    {
      title: 'Language',
      dataIndex: 'language',
    ...
    <Card size="small" style={{ margin: '8px 0' }}>
      <Space direction="vertical" style={{ width: '100%' }}>
        ...
        {record.error_message && (
          <div>
            <Text strong type="danger">Error:</Text> {record.error_message}
          </div>
        )}
      </Space>
    </Card>
