...
describe('TagCloud', () => {
  const tags: TagType[] = [
    { id: '1', name: 'Tag1', color: '#1890ff', usage_count: 10, is_system: false, description: '', created_at: '', },
    { id: '2', name: 'Tag2', color: '#ff0000', usage_count: 5, is_system: true, description: '', created_at: '', },
  ];
