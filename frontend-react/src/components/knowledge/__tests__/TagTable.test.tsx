...
describe('TagTable', () => {
  const tags: TagType[] = [
    { id: '1', name: 'Tag1', color: '#1890ff', usage_count: 10, is_system: false, description: 'desc', created_at: '2023-01-01' },
    { id: '2', name: 'Tag2', color: '#ff0000', usage_count: 0, is_system: true, description: '', created_at: '2023-01-02' },
  ];
  ...
  it('calls onTagSelect when Select button is clicked (selection mode)', () => {
    ...
    render(<TagTable tags={tags} loading={false} mode="selection" onTagSelect={onTagSelect} />);
  ...
  it('calls onEditTag when Edit button is clicked (management mode)', () => {
    ...
    render(<TagTable tags={tags} loading={false} mode="management" onEditTag={onEditTag} />);
  ...
  it('calls onDeleteTag when Delete button is confirmed (management mode)', () => {
    ...
    render(<TagTable tags={tags} loading={false} mode="management" onDeleteTag={onDeleteTag} />);
