...
import { EyeOutlined, EyeInvisibleOutlined, SearchOutlined, ClearOutlined } from '@ant-design/icons';
    ...
    <div className="modern-input-wrapper">
      {label && (
        <label className="modern-input__label">
          {label}
          {props.required && <span className="modern-input__required">*</span>}
        </label>
      )}
      ...
      {helperText && (
        <div className={`modern-input__helper-text modern-input__helper-text--${status}`}>
          {helperText}
        </div>
      )}
    </div>
