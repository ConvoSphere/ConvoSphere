        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
          ...
          <div style={{ padding: '1rem', border: '1px solid #eee', borderRadius: '8px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '1rem' }}>
              ...
              <nav>
                <a href="#" style={{ marginLeft: '1rem', textDecoration: 'none', color: '#23224A' }}>Home</a>
                <a href="#" style={{ marginLeft: '1rem', textDecoration: 'none', color: '#23224A' }}>Chat</a>
                <a href="#" style={{ marginLeft: '1rem', textDecoration: 'none', color: '#23224A' }}>Settings</a>
              </nav>
            </div>
          </div>
