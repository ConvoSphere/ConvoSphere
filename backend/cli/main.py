...
def create_parser():
    ...
    parser = argparse.ArgumentParser(
        description="ChatAssistant Admin CLI",
        add_help=False
    )
    ...
    downgrade_parser = db_subparsers.add_parser('downgrade', help='Downgrade to specific revision')
    ...
    user_subparsers = user_parser.add_subparsers(dest='subcommand', help='User subcommands')
    ...
    backup_subparsers = backup_parser.add_subparsers(dest='subcommand', help='Backup subcommands')
    ...
    monitoring_subparsers = monitoring_parser.add_subparsers(dest='subcommand', help='Monitoring subcommands')
    ...
    assistant_subparsers = assistant_parser.add_subparsers(dest='subcommand', help='Assistant subcommands')
    
    assistant_subparsers.add_parser('list', help='List assistants')
    
    show_assistant_parser = assistant_subparsers.add_parser('show', help='Show assistant details')
    ...
    delete_assistant_parser = assistant_subparsers.add_parser('delete', help='Delete assistant')
    delete_assistant_parser.add_argument('assistant_id', help='Assistant ID or name')
    delete_assistant_parser.add_argument('--confirm', action='store_true', help='Confirm deletion')
    
    activate_parser = assistant_subparsers.add_parser('activate', help='Activate assistant')
    activate_parser.add_argument('assistant_id', help='Assistant ID or name')
    
    deactivate_parser = assistant_subparsers.add_parser('deactivate', help='Deactivate assistant')
    ...
    test_data_parser.add_argument('--users', type=int, default=5, help='Number of test users')
