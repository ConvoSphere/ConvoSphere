...
class TestKnowledgeAPI:
    ...
    def test_get_documents_with_filters(self, db_session: Session, test_user: User):
        ...
        response = client.get(
            "/api/v1/knowledge/documents?year=2024",
            headers=headers
        )
    ...
    def test_advanced_search(self, mock_weaviate, mock_embedding, db_session: Session, test_user: User):
    ...
    def test_invalid_processing_options(self, db_session: Session, test_user: User):
        ...
        try:
            with open(temp_file_path, 'rb') as f:
                ...
                data = {
                    "title": "Test Document",
                    "processing_options": "invalid json"
                }
