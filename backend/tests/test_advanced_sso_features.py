...
from app.services.advanced_user_provisioning import (
...
class TestConditionalProvisioning:
    ...
    def test_auto_approve_domain(self, provisioning):
        ...
        user_info = {
            'email': 'user@trusted-partner.com',
            'first_name': 'John'
        }
...
class TestAdvancedUserProvisioning:
    ...
    def test_provision_user_approved(self, provisioning, mock_db, mock_user_service):
        ...
        # Mock user service
        with patch('app.services.advanced_user_provisioning.UserService') as mock_service_class:
    ...
    def test_get_user_provisioning_status(self, provisioning, mock_db):
        ...
        with patch('app.services.advanced_user_provisioning.UserService') as mock_service_class:
            ...
            status_info = await provisioning.get_user_provisioning_status(user_id, mock_db)
