...
# from app.main import app  # Commented out for testing without full app context
...
class TestSSOLoadTesting:
    ...
    def test_sustained_load(self, client):
        ...
        print(f"Sustained load: {request_count} requests, {error_count} errors in {total_time:.1f}s (error rate: {error_rate*100:.1f}%)")
...
class TestSSOSecurityPerformance:
    ...
    def test_csrf_protection_performance(self, client):
        ...
        for _ in range(100):
            ...
            response = client.get("/api/v1/auth/sso/providers", headers={
        ...
        print(f"CSRF protection: valid={valid_time:.2f}s, malicious={malicious_time:.2f}s")
    ...
    def test_rate_limiting_simulation(self, client):
        ...
        print(f"Rate limiting simulation: {len(response_times)} requests, no significant degradation")