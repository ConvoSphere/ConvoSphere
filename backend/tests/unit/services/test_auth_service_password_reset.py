...
class TestAuthServicePasswordReset:
    ...
    def test_request_password_reset_success(
        ...
        mock_token_service.create_password_reset_token.assert_called_once_with(
            sample_user, mock_db
        )
    ...
    def test_reset_password_with_token_success(
        ...
        assert result is True
        mock_token_service.validate_password_reset_token.assert_called_once_with(
            "valid_token", mock_db
        )
        mock_token_service.get_user_by_reset_token.assert_called_once_with(
            "valid_token", mock_db
        )
        mock_token_service.clear_password_reset_token.assert_called_once_with(
            sample_user, mock_db
        )
