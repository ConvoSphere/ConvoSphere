...
class TestTokenService:
    ...
    def test_validate_password_reset_token_valid(self, token_service, mock_db, sample_user):
    ...
    def test_validate_password_reset_token_expired(self, token_service, mock_db, sample_user):
        ...
        # Test validation
        result = token_service.validate_password_reset_token("expired_token_123", mock_db)
    ...
    def test_cleanup_expired_tokens(self, token_service, mock_db):
        ...
        # Mock database query
        mock_db.query.return_value.filter.return_value.all.return_value = [expired_user1, expired_user2]
        mock_db.commit.return_value = None
