...
class DatabaseMonitor:
        ...
        try:
            ...
            def after_cursor_execute(conn, cursor, statement, parameters, context, executemany):
                ...
                self.connection_metrics["avg_query_time"] = (
                    (self.connection_metrics["avg_query_time"] * (self.connection_metrics["total_queries"] - 1) + query_time) /
        ...
        try:
            ...
            return {
                ...
                "queries": {
                    ...
                    "query_count_by_type": dict(self.connection_metrics["query_count_by_type"]),
                },
                "performance": {
                    "slow_query_percentage": (
                        (self.connection_metrics["slow_queries"] / self.connection_metrics["total_queries"] * 100)
                        if self.connection_metrics["total_queries"] > 0 else 0.0
                    ),
    ...
    def _get_query_type_distribution(self, queries: list[dict[str, Any]]) -> dict[str, int]:
