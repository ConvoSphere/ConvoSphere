...
class RBACCache:
    ...
    def get_role_permissions(self, role: UserRole) -> Optional[Set[str]]:
    ...
    def get_user_groups(self, user_id: str) -> Optional[List[Dict[str, Any]]]:
    ...
    def invalidate_permission_evaluation(self, user_id: str, permission: str = None) -> bool:
...
def cache_permission_evaluation(ttl: int = 60):
    ...
    def decorator(func):
        ...
        def wrapper(user: User, permission: str, resource: Any = None, *args, **kwargs):
            # Check cache first
            resource_id = str(resource.id) if resource and hasattr(resource, 'id') else None
...
class CachedUserPermissions:
    ...
    def __init__(self, user: User):
        ...
        self._groups: Optional[List[Dict[str, Any]]] = None
...
class RBACPerformanceMonitor:
    ...
    def record_permission_check(self, user_id: str, permission: str, duration: float, cached: bool):
