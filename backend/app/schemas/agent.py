...
class AgentConfig(BaseModel):
    ...
    def validate_tools(cls, v: List[str]) -> List[str]:
        ...
        cleaned_tools = list(set(tool.strip() for tool in v if tool and tool.strip()))
...
class AgentUpdate(BaseModel):
    ...
    description: Optional[str] = Field(None, min_length=1, max_length=2000, description="Agent description")
    system_prompt: Optional[str] = Field(None, min_length=1, max_length=10000, description="System prompt")
    tools: Optional[List[str]] = Field(None, max_length=50, description="List of tool names")
    model: Optional[str] = Field(None, min_length=1, max_length=100, description="AI model to use")
    ...
    max_context_length: Optional[int] = Field(None, ge=1000, le=200000, description="Maximum context length")
    personality: Optional[str] = Field(None, max_length=5000, description="Agent personality description")
    instructions: Optional[str] = Field(None, max_length=10000, description="Additional instructions")
