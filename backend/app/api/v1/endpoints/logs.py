    ...
    try:
        ...
        for log_event_data in request.logs:
            ...
            log_event(
                ...
                user_id=log_event_data.userId or (current_user.id if current_user else None),
        ...
        return {"status": "success", "processed_logs": 0, "warning": "Some logs may not have been processed"}
