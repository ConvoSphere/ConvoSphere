...
class ToolCreate(BaseModel):
    ...
    function_name: str = Field(..., min_length=1, max_length=200, description="Unique function name")
    parameters_schema: Optional[Dict[str, Any]] = Field(None, description="JSON Schema for parameters")
    implementation_path: Optional[str] = Field(None, description="Path to implementation")
    ...
    rate_limit: Optional[str] = Field(None, description="Rate limiting configuration")
    tags: List[str] = Field(default_factory=list, description="Tool tags")
    tool_metadata: Dict[str, Any] = Field(default_factory=dict, description="Additional metadata")


class ToolUpdate(BaseModel):
    """Update tool request model."""
    name: Optional[str] = Field(None, min_length=1, max_length=200, description="Tool name")
    description: Optional[str] = Field(None, description="Tool description")
    ...
    requires_auth: Optional[bool] = Field(None, description="Whether tool requires authentication")
    ...
    tool_metadata: Optional[Dict[str, Any]] = Field(None, description="Additional metadata")
...
async def get_tools(
    ...
    search: Optional[str] = Query(None, description="Search in tool name and description"),
