...
from app.services.enhanced_tool_executor import enhanced_tool_executor
...
class MultiAgentManager:
    ...
    def get_conversation_state(self, conversation_id: str) -> Optional[MultiAgentConversation]:
        """Get conversation state."""
        return self.active_conversations.get(conversation_id)
    
    def get_agent_state(self, conversation_id: str, agent_id: str) -> Optional[AgentState]:
