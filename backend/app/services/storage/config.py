...
class StorageConfig(BaseModel):
    ...
    minio_endpoint: Optional[str] = Field(default="localhost:9000", description="MinIO endpoint")
    minio_access_key: Optional[str] = Field(default="minioadmin", description="MinIO access key")
    minio_secret_key: Optional[str] = Field(default="minioadmin", description="MinIO secret key")
    ...
    gcs_credentials_file: Optional[str] = Field(default=None, description="GCS credentials file path")
    gcs_credentials_json: Optional[str] = Field(default=None, description="GCS credentials as JSON string")
    ...
    azure_connection_string: Optional[str] = Field(default=None, description="Azure connection string")
    azure_sas_token: Optional[str] = Field(default=None, description="Azure SAS token")
    
    # Local storage settings
    local_base_path: Optional[str] = Field(default="./uploads", description="Local storage base path")
    ...
    encryption_key: Optional[str] = Field(default=None, description="Encryption key for client-side encryption")
