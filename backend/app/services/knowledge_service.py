...
# from .ai_service import AIService  # Circular import - removed
...
class KnowledgeService:
    ...
    def __init__(self, db=None):
        ...
        # self.ai_service = AIService()  # Circular import - commented out
...
# Global knowledge service instance - initialize lazily to avoid asyncio issues
