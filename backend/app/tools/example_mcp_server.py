...
class ExampleMCPServer:
    ...
    async def handle_initialize(self, data: Dict[str, Any], request_id: int) -> web.Response:
    ...
    async def handle_list_tools(self, data: Dict[str, Any], request_id: int) -> web.Response:
    ...
    async def handle_call_tool(self, data: Dict[str, Any], request_id: int) -> web.Response:
    ...
    async def handle_list_resources(self, data: Dict[str, Any], request_id: int) -> web.Response:
    ...
    async def handle_read_resource(self, data: Dict[str, Any], request_id: int) -> web.Response:
    ...
    def create_error_response(self, request_id: int, code: int, message: str) -> web.Response:
