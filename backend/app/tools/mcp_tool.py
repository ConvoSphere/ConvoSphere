...
class MCPServerManager:
    ...
    async def add_server(self, server_id: str, server_url: str, server_name: str = None) -> bool:
        """
        ...
        try:
            ...
            if await client.connect():
                ...
                logger.info(f"Added MCP server {server_id} with {len(client.tools)} tools")
                return True
            else:
                return False
    ...
    async def remove_server(self, server_id: str) -> bool:
        ...
        if server_id in self.servers:
            ...
            tools_to_remove = [tool_id for tool_id in self.tools.keys() if tool_id.startswith(f"{server_id}_")]
    ...
    def get_tool(self, tool_id: str) -> Optional[MCPToolWrapper]:
        """
        Get tool by ID.
