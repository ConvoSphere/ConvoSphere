...
class TestAIService:
    ...
    @pytest.mark.asyncio
    async def test_chat_completion_with_tools(self, ai_service, mock_litellm, sample_messages):
    ...
    @pytest.mark.asyncio
    async def test_chat_completion_with_rag(self, ai_service, mock_litellm, sample_messages):
        ...
        with patch.object(ai_service, '_search_knowledge_for_context') as mock_search:
            ...
            with patch.object(ai_service, '_prepare_tools_for_completion') as mock_tools:
    ...
    @pytest.mark.asyncio
    async def test_generate_response_with_tools(self, ai_service, mock_litellm, sample_messages):
    ...
    @pytest.mark.asyncio
    async def test_error_handling_chat_completion(self, ai_service, mock_litellm, sample_messages):
