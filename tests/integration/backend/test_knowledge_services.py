...
class TestKnowledgeService:
    ...
    def test_determine_document_type(self, db_session: Session):
        ...
        assert (
            knowledge_service._determine_document_type("pdf", "application/pdf")
            == DocumentType.PDF
        )
        assert (
        ...
        assert (
            knowledge_service._determine_document_type("txt", "text/plain")
            == DocumentType.TEXT
        )
        assert (
            knowledge_service._determine_document_type(
    ...
    def test_get_search_history(self, db_session: Session, test_user: User):
        ...
        from backend.app.models.knowledge import SearchQuery
