...
class TestRBACManagementAPI:
    ...
    def admin_headers(self, client: TestClient, admin_user: User) -> Dict[str, str]:
        ...
        # Mock authentication
        with patch('backend.app.api.v1.endpoints.rbac_management.get_current_user') as mock_auth:
    ...
    def test_create_permission_success(self, client: TestClient, admin_headers: Dict[str, str], sample_permission_data: Dict[str, Any]):
        """Test successful permission creation."""
        with patch('backend.app.api.v1.endpoints.rbac_management.RBACService') as mock_rbac:
    ...
    def test_create_permission_unauthorized(self, client: TestClient, user_headers: Dict[str, str], sample_permission_data: Dict[str, Any]):
    ...
    def test_list_permissions_success(self, client: TestClient, admin_headers: Dict[str, str]):
    ...
    def test_list_permissions_with_filters(self, client: TestClient, admin_headers: Dict[str, str]):
    ...
    def test_get_permission_success(self, client: TestClient, admin_headers: Dict[str, str]):
    ...
    def test_get_permission_not_found(self, client: TestClient, admin_headers: Dict[str, str]):
        ...
        with patch('backend.app.api.v1.endpoints.rbac_management.RBACService') as mock_rbac:
            ...
            response = client.get(
                "/api/v1/rbac/permissions/nonexistent",
                headers=admin_headers
            )

            assert response.status_code == 404

    def test_update_permission_success(self, client: TestClient, admin_headers: Dict[str, str]):
    ...
    def test_delete_permission_success(self, client: TestClient, admin_headers: Dict[str, str]):
    ...
    def test_create_abac_rule_success(self, client: TestClient, admin_headers: Dict[str, str], sample_abac_rule_data: Dict[str, Any]):
    ...
    def test_list_abac_rules_success(self, client: TestClient, admin_headers: Dict[str, str]):
    ...
    def test_get_abac_rule_success(self, client: TestClient, admin_headers: Dict[str, str]):
    ...
    def test_update_abac_rule_success(self, client: TestClient, admin_headers: Dict[str, str]):
    ...
    def test_delete_abac_rule_success(self, client: TestClient, admin_headers: Dict[str, str]):
    ...
    def test_create_abac_policy_success(self, client: TestClient, admin_headers: Dict[str, str], sample_abac_policy_data: Dict[str, Any]):
    ...
    def test_list_abac_policies_success(self, client: TestClient, admin_headers: Dict[str, str]):
    ...
    def test_test_permission_success(self, client: TestClient, admin_headers: Dict[str, str]):
    ...
    def test_get_rbac_stats_success(self, client: TestClient, admin_headers: Dict[str, str]):
    ...
    def test_get_cache_stats_success(self, client: TestClient, admin_headers: Dict[str, str]):
        """Test cache statistics endpoint."""
        with patch('backend.app.api.v1.endpoints.rbac_management.rbac_cache') as mock_cache:
    ...
    def test_get_performance_stats_success(self, client: TestClient, admin_headers: Dict[str, str]):
        """Test performance statistics endpoint."""
        with patch('backend.app.api.v1.endpoints.rbac_management.rbac_performance_monitor') as mock_monitor:
            ...
            response = client.get(
                "/api/v1/rbac/performance/stats/user_123",
                headers=admin_headers
            )
    ...
    def test_clear_rbac_cache_success(self, client: TestClient, admin_headers: Dict[str, str]):
        """Test cache clearing endpoint."""
        with patch('backend.app.api.v1.endpoints.rbac_management.rbac_cache') as mock_cache:
            mock_cache.clear.return_value = True

            response = client.post(
                "/api/v1/rbac/cache/clear",
                headers=admin_headers
            )
    ...
    def test_clear_rbac_cache_for_user(self, client: TestClient, admin_headers: Dict[str, str]):
        """Test cache clearing for specific user."""
        with patch('backend.app.api.v1.endpoints.rbac_management.rbac_cache') as mock_cache:
            mock_cache.clear_user_cache.return_value = True

            response = client.post(
                "/api/v1/rbac/cache/clear?user_id=user_123",
                headers=admin_headers
            )
    ...
    def test_get_security_events_success(self, client: TestClient, admin_headers: Dict[str, str]):
    ...
    def test_get_security_events_with_filters(self, client: TestClient, admin_headers: Dict[str, str]):
    ...
    def test_get_permission_matrix_success(self, client: TestClient, admin_headers: Dict[str, str]):
    ...
    def test_invalid_permission_data(self, client: TestClient, admin_headers: Dict[str, str]):
    ...
    def test_invalid_abac_rule_data(self, client: TestClient, admin_headers: Dict[str, str]):
    ...
    def test_permission_denied_error_handling(self, client: TestClient, admin_headers: Dict[str, str]):
    ...
    def test_database_error_handling(self, client: TestClient, admin_headers: Dict[str, str]):
    ...
    def test_pagination_support(self, client: TestClient, admin_headers: Dict[str, str]):
        ...
        with patch('backend.app.api.v1.endpoints.rbac_management.RBACService') as mock_rbac:
            ...
            response = client.get(
                "/api/v1/rbac/permissions?page=1&size=10",
                headers=admin_headers
            )
