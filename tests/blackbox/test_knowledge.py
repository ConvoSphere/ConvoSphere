...
class TestDocumentManagement:
    ...
    def test_upload_document_success(
        self, api_client, assertion_helper, authenticated_user, test_data_manager
    ):
        ...
        with open(file_path, "rb") as f:
            ...
            response = api_client.post(
                "/knowledge/documents", data=data, files=files, user_type="regular_user"
            )
    ...
    def test_upload_document_invalid_file(
        ...
        response = api_client.post(
            "/knowledge/documents", data=data, user_type="regular_user"
        )
    ...
    def test_upload_document_unauthorized(
        self, api_client, assertion_helper, test_data_manager
    ):
    ...
    def test_get_documents_list(self, api_client, assertion_helper, authenticated_user):
        ...
        assertion_helper.assert_response_structure(
            response.json(), ["documents", "total", "page", "size"]
        )
        assertion_helper.assert_list_response(response.json()["documents"])

    @pytest.mark.blackbox
    @pytest.mark.knowledge
    def test_get_documents_list_with_filters(
        self, api_client, assertion_helper, authenticated_user
    ):
        ...
        # Test with search
        response = api_client.get(
            "/knowledge/documents", params={"search": "test"}, user_type="regular_user"
        )
        assertion_helper.assert_success_response(response, 200)

        # Test with tags filter
        response = api_client.get(
            "/knowledge/documents", params={"tags": "test"}, user_type="regular_user"
        )
        assertion_helper.assert_success_response(response, 200)
    ...
    def test_get_document_by_id_not_found(
        ...
        response = api_client.get(
            "/knowledge/documents/999999", user_type="regular_user"
        )
    ...
    def test_update_document(self, api_client, assertion_helper, test_document):
        ...
        response = api_client.put(
            f"/knowledge/documents/{document_id}", data=update_data
        )
    ...
    def test_delete_document(
        ...
        response = api_client.delete(
            f"/knowledge/documents/{document_id}", user_type="regular_user"
        )
    ...
    def test_download_document_not_found(
        ...
        response = api_client.get(
            "/knowledge/documents/999999/download", user_type="regular_user"
        )
        assertion_helper.assert_not_found(response)
    ...
    @pytest.mark.blackbox
    @pytest.mark.knowledge
    def test_upload_advanced_document(
        self, api_client, assertion_helper, authenticated_user, test_data_manager
    ):
...
class TestDocumentSearch:
    ...
    def test_search_documents(self, api_client, assertion_helper, authenticated_user):
        ...
        response = api_client.post(
            "/knowledge/search", data=search_data, user_type="regular_user"
        )

        assertion_helper.assert_success_response(response, 200)
        assertion_helper.assert_response_structure(
            response.json(), ["results", "total", "query"]
        )
    ...
    def test_advanced_search_documents(
        ...
        response = api_client.post(
            "/knowledge/search/advanced", data=search_data, user_type="regular_user"
        )

        assertion_helper.assert_success_response(response, 200)
        assertion_helper.assert_response_structure(
            response.json(), ["results", "total", "query", "filters"]
        )
        assertion_helper.assert_list_response(response.json()["results"])
...
class TestTagManagement:
    ...
    def test_search_tags(self, api_client, assertion_helper, authenticated_user):
        ...
        response = api_client.get(
            "/knowledge/tags/search", params={"query": "test"}, user_type="regular_user"
        )
...
class TestProcessingManagement:
    ...
    def test_get_processing_jobs(
        ...
        response = api_client.get(
            "/knowledge/processing/jobs", user_type="regular_user"
        )

        assertion_helper.assert_success_response(response, 200)
        assertion_helper.assert_response_structure(
            response.json(), ["jobs", "total", "page", "size"]
        )
        assertion_helper.assert_list_response(response.json()["jobs"])

    @pytest.mark.blackbox
    @pytest.mark.knowledge
    def test_get_processing_jobs_with_status_filter(
        self, api_client, assertion_helper, authenticated_user
    ):
    ...
    @pytest.mark.blackbox
    @pytest.mark.knowledge
    def test_get_processing_engines(
        self, api_client, assertion_helper, authenticated_user
    ):
        ...
        response = api_client.get(
            "/knowledge/processing/engines", user_type="regular_user"
        )
    ...
    def test_get_supported_formats(
        ...
        response = api_client.get(
            "/knowledge/processing/supported-formats", user_type="regular_user"
        )
...
class TestKnowledgeValidation:
    ...
    @pytest.mark.blackbox
    @pytest.mark.knowledge
    def test_upload_document_missing_required_fields(
        self, api_client, assertion_helper, authenticated_user, test_data_manager
    ):
    ...
    @pytest.mark.blackbox
    @pytest.mark.knowledge
    def test_update_document_invalid_data(
        self, api_client, assertion_helper, test_document
    ):
        ...
        response = api_client.put(
            f"/knowledge/documents/{document_id}", data=invalid_data
        )
        assertion_helper.assert_error_response(response, 422)
    ...
    def test_search_invalid_query(
        ...
        response = api_client.post(
            "/knowledge/search", data=invalid_data, user_type="regular_user"
        )
        assertion_helper.assert_error_response(response, 422)
