...
class TestToolManagementEndpoints:
    ...
    @pytest.mark.blackbox
    @pytest.mark.tools
    def test_get_tools_list_with_filters(self, api_client, assertion_helper, authenticated_user):
        """Test getting tools list with filters."""
        token, user_data = authenticated_user
        
        # Test with category filter
        response = api_client.get("/tools/", params={"category": "search"}, user_type="regular_user")
        assertion_helper.assert_success_response(response, 200)
        
        # Test with search filter
        response = api_client.get("/tools/", params={"search": "test"}, user_type="regular_user")
        assertion_helper.assert_success_response(response, 200)
    ...
    def test_get_tool_by_id(self, api_client, assertion_helper, authenticated_user):
        ...
        if tools_response.status_code == 200 and tools_response.json():
            ...
            assertion_helper.assert_response_structure(response.json(), [
                "id", "name", "description", "category", "function_name", "parameters"
            ])
    ...
    @pytest.mark.blackbox
    @pytest.mark.tools
    def test_get_tool_by_id_not_found(self, api_client, assertion_helper, authenticated_user):
    ...
    @pytest.mark.blackbox
    @pytest.mark.tools
    def test_get_tool_categories(self, api_client, assertion_helper, authenticated_user):
...
class TestToolExecution:
    ...
    def test_execute_tool(self, api_client, assertion_helper, authenticated_user):
        ...
        if tools_response.status_code == 200 and tools_response.json():
            ...
            response = api_client.post(f"/tools/{tool_id}/execute", data=execution_data, user_type="regular_user")
    ...
    @pytest.mark.blackbox
    @pytest.mark.tools
    def test_execute_tool_invalid_parameters(self, api_client, assertion_helper, authenticated_user):
        ...
        if tools_response.status_code == 200 and tools_response.json():
            ...
            response = api_client.post(f"/tools/{tool_id}/execute", data=invalid_data, user_type="regular_user")
    ...
    @pytest.mark.blackbox
    @pytest.mark.tools
    def test_execute_tool_not_found(self, api_client, assertion_helper, authenticated_user):
        ...
        response = api_client.post("/tools/999999/execute", data=execution_data, user_type="regular_user")
        assertion_helper.assert_not_found(response)
...
class TestToolValidation:
    ...
    @pytest.mark.blackbox
    @pytest.mark.tools
    def test_execute_tool_missing_parameters(self, api_client, assertion_helper, authenticated_user):
    ...
    @pytest.mark.blackbox
    @pytest.mark.tools
    def test_execute_tool_empty_parameters(self, api_client, assertion_helper, authenticated_user):
        ...
        if tools_response.status_code == 200 and tools_response.json():
            ...
            response = api_client.post(f"/tools/{tool_id}/execute", data=empty_data, user_type="regular_user")
...
class TestToolIntegration:
    ...
    def test_tool_with_assistant_integration(self, api_client, assertion_helper, test_assistant):
    ...
    @pytest.mark.tools
    @pytest.mark.integration
    def test_tool_availability_for_different_roles(self, api_client, assertion_helper, authenticated_user, authenticated_admin):
...
class TestToolErrorHandling:
    ...
    @pytest.mark.blackbox
    @pytest.mark.tools
    def test_tool_execution_timeout(self, api_client, assertion_helper, authenticated_user):
        ...
        if tools_response.status_code == 200 and tools_response.json():
            ...
            response = api_client.post(f"/tools/{tool_id}/execute", data=timeout_data, user_type="regular_user")
    ...
    @pytest.mark.blackbox
    @pytest.mark.tools
    def test_tool_execution_invalid_input(self, api_client, assertion_helper, authenticated_user):
