...
class TestConversationManagementEndpoints:
    ...
    def test_create_conversation_success(self, api_client, assertion_helper, test_assistant):
    ...
    @pytest.mark.blackbox
    @pytest.mark.conversations
    def test_get_conversations_list(self, api_client, assertion_helper, authenticated_user):
        ...
        assertion_helper.assert_response_structure(response.json(), [
            "conversations", "total", "page", "size"
        ])
        assertion_helper.assert_list_response(response.json()["conversations"])
    
    @pytest.mark.blackbox
    @pytest.mark.conversations
    def test_get_conversations_list_with_filters(self, api_client, assertion_helper, authenticated_user):
        """Test getting conversations list with filters."""
        token, user_data = authenticated_user
        
        # Test with pagination
        response = api_client.get("/conversations/", params={"page": 1, "size": 10}, user_type="regular_user")
        assertion_helper.assert_success_response(response, 200)
        
        # Test with search
        response = api_client.get("/conversations/", params={"search": "test"}, user_type="regular_user")
        assertion_helper.assert_success_response(response, 200)
    
    @pytest.mark.blackbox
    @pytest.mark.conversations
    def test_get_conversation_by_id(self, api_client, assertion_helper, test_conversation):
    ...
    @pytest.mark.blackbox
    @pytest.mark.conversations
    def test_get_conversation_by_id_not_found(self, api_client, assertion_helper, authenticated_user):
    ...
    @pytest.mark.blackbox
    @pytest.mark.conversations
    def test_delete_conversation(self, api_client, assertion_helper, authenticated_user, test_assistant):
        ...
        create_response = api_client.post("/conversations/", data=conversation_data, user_type="regular_user")
        conversation_id = create_response.json()["id"]
        
        # Delete the conversation
        response = api_client.delete(f"/conversations/{conversation_id}", user_type="regular_user")
        assertion_helper.assert_success_response(response, 204)
        
        # Verify conversation is deleted
        get_response = api_client.get(f"/conversations/{conversation_id}", user_type="regular_user")
        assertion_helper.assert_not_found(get_response)
    
    @pytest.mark.blackbox
    @pytest.mark.conversations
    def test_archive_conversation(self, api_client, assertion_helper, test_conversation):
...
class TestMessageManagement:
    ...
    @pytest.mark.blackbox
    @pytest.mark.conversations
    def test_create_message_success(self, api_client, assertion_helper, test_conversation):
        ...
        response = api_client.post(f"/conversations/{conversation_id}/messages", data=message_data)
    ...
    @pytest.mark.blackbox
    @pytest.mark.conversations
    def test_create_message_invalid_data(self, api_client, assertion_helper, test_conversation):
        ...
        response = api_client.post(f"/conversations/{conversation_id}/messages", data=invalid_data)
        assertion_helper.assert_error_response(response, 422)
    ...
    @pytest.mark.blackbox
    @pytest.mark.conversations
    def test_get_conversation_messages(self, api_client, assertion_helper, test_conversation):
        ...
        if messages:
            assertion_helper.assert_response_structure(messages[0], [
                "id", "content", "role", "conversation_id", "created_at"
            ])
    
    @pytest.mark.blackbox
    @pytest.mark.conversations
    def test_get_conversation_messages_with_pagination(self, api_client, assertion_helper, test_conversation):
        """Test getting messages with pagination."""
        conversation_id = test_conversation["id"]
        
        response = api_client.get(f"/conversations/{conversation_id}/messages", params={
            "page": 1,
            "size": 10
        })
...
class TestChatEndpoints:
    ...
    @pytest.mark.blackbox
    @pytest.mark.conversations
    def test_get_chat_conversations(self, api_client, assertion_helper, authenticated_user):
    ...
    @pytest.mark.blackbox
    @pytest.mark.conversations
    def test_get_chat_conversation_messages(self, api_client, assertion_helper, test_conversation):
    ...
    @pytest.mark.blackbox
    @pytest.mark.conversations
    def test_get_chat_conversation_messages_not_found(self, api_client, assertion_helper):
...
class TestConversationValidation:
    ...
    @pytest.mark.blackbox
    @pytest.mark.conversations
    def test_create_conversation_missing_required_fields(self, api_client, assertion_helper):
    ...
    @pytest.mark.blackbox
    @pytest.mark.conversations
    def test_create_conversation_invalid_assistant_id(self, api_client, assertion_helper):
    ...
    @pytest.mark.blackbox
    @pytest.mark.conversations
    def test_update_conversation_invalid_data(self, api_client, assertion_helper, test_conversation):
        ...
        response = api_client.put(f"/conversations/{conversation_id}", data=invalid_data)
        assertion_helper.assert_error_response(response, 422)
    
    @pytest.mark.blackbox
    @pytest.mark.conversations
    def test_create_message_missing_content(self, api_client, assertion_helper, test_conversation):
    ...
    @pytest.mark.blackbox
    @pytest.mark.conversations
    def test_create_message_invalid_role(self, api_client, assertion_helper, test_conversation):
...
class TestConversationPermissions:
    ...
    @pytest.mark.blackbox
    @pytest.mark.conversations
    def test_access_conversation_unauthorized(self, api_client, assertion_helper, test_conversation):
    ...
    @pytest.mark.blackbox
    @pytest.mark.conversations
    def test_create_message_unauthorized(self, api_client, assertion_helper, test_conversation):
    ...
    @pytest.mark.blackbox
    @pytest.mark.conversations
    def test_update_conversation_unauthorized(self, api_client, assertion_helper, test_conversation):
    ...
    @pytest.mark.blackbox
    @pytest.mark.conversations
    def test_delete_conversation_unauthorized(self, api_client, assertion_helper, test_conversation):
