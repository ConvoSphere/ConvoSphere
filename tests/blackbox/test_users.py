...
class TestUserManagementEndpoints:
    ...
    @pytest.mark.users
    def test_create_user_success(self, api_client, assertion_helper, authenticated_admin):
    ...
    @pytest.mark.blackbox
    @pytest.mark.users
    def test_create_user_unauthorized(self, api_client, assertion_helper, authenticated_user):
        ...
        response = api_client.post("/users/", data=new_user_data, user_type="regular_user")
    ...
    def test_get_users_list(self, api_client, assertion_helper, authenticated_admin):
        ...
        assertion_helper.assert_response_structure(response.json(), ["users", "total", "page", "size"])
        assertion_helper.assert_list_response(response.json()["users"], 1)  # At least admin user
    
    @pytest.mark.blackbox
    @pytest.mark.users
    def test_get_users_list_unauthorized(self, api_client, assertion_helper, authenticated_user):
    ...
    @pytest.mark.blackbox
    @pytest.mark.users
    def test_get_user_by_id_not_found(self, api_client, assertion_helper, authenticated_admin):
    ...
    @pytest.mark.blackbox
    @pytest.mark.users
    def test_update_user_profile(self, api_client, assertion_helper, authenticated_user):
        ...
        response = api_client.put("/users/me/profile", data=update_data, user_type="regular_user")
    ...
    @pytest.mark.blackbox
    @pytest.mark.users
    def test_update_user_password(self, api_client, assertion_helper, authenticated_user):
        ...
        response = api_client.put("/users/me/password", data=password_data, user_type="regular_user")
        assertion_helper.assert_success_response(response, 200)
    
    @pytest.mark.blackbox
    @pytest.mark.users
    def test_update_user_password_wrong_current(self, api_client, assertion_helper, authenticated_user):
    ...
    @pytest.mark.blackbox
    @pytest.mark.users
    def test_search_user_by_email(self, api_client, assertion_helper, authenticated_admin):
        """Test searching user by email."""
        token, admin_data = authenticated_admin
        
        response = api_client.get(f"/users/search/email/{admin_data['email']}", user_type="admin_user")
    ...
    @pytest.mark.blackbox
    @pytest.mark.users
    def test_search_user_by_username(self, api_client, assertion_helper, authenticated_admin):
        """Test searching user by username."""
        token, admin_data = authenticated_admin
        
        response = api_client.get(f"/users/search/username/{admin_data['username']}", user_type="admin_user")
    ...
    @pytest.mark.blackbox
    @pytest.mark.users
    def test_get_default_language(self, api_client, assertion_helper, authenticated_admin):
        """Test getting default language setting."""
        token, admin_data = authenticated_admin
        
        response = api_client.get("/users/admin/default-language", user_type="admin_user")
...
class TestUserGroups:
    ...
    @pytest.mark.blackbox
    @pytest.mark.users
    def test_assign_user_to_group(self, api_client, assertion_helper, authenticated_admin):
        ...
        if groups:
            ...
            response = api_client.post("/users/groups/assign", data=assignment_data, user_type="admin_user")
    ...
    def test_get_group_by_id(self, api_client, assertion_helper, authenticated_admin):
        ...
        if groups:
            ...
            response = api_client.get(f"/users/groups/{group_id}", user_type="admin_user")
    ...
    @pytest.mark.blackbox
    @pytest.mark.users
    def test_get_group_by_id_not_found(self, api_client, assertion_helper, authenticated_admin):
...
class TestBulkOperations:
    ...
    def test_bulk_update_users(self, api_client, assertion_helper, authenticated_admin):
        ...
        if len(users) >= 2:
            ...
            response = api_client.put("/users/bulk-update", data=bulk_update_data, user_type="admin_user")
    ...
    @pytest.mark.blackbox
    @pytest.mark.users
    def test_bulk_update_users_unauthorized(self, api_client, assertion_helper, authenticated_user):
        ...
        response = api_client.put("/users/bulk-update", data=bulk_update_data, user_type="regular_user")
        assertion_helper.assert_unauthorized(response)
...
class TestUserValidation:
    ...
    @pytest.mark.blackbox
    @pytest.mark.users
    def test_create_user_invalid_email(self, api_client, assertion_helper, authenticated_admin):
    ...
    @pytest.mark.blackbox
    @pytest.mark.users
    def test_create_user_duplicate_email(self, api_client, assertion_helper, authenticated_admin):
    ...
    @pytest.mark.blackbox
    @pytest.mark.users
    def test_create_user_invalid_role(self, api_client, assertion_helper, authenticated_admin):
    ...
    @pytest.mark.blackbox
    @pytest.mark.users
    def test_update_profile_invalid_data(self, api_client, assertion_helper, authenticated_user):
        ...
        response = api_client.put("/users/me/profile", data=invalid_data, user_type="regular_user")
        assertion_helper.assert_error_response(response, 422) 