...
class TestAssistantManagementEndpoints:
    ...
    def test_create_assistant_success(
        ...
        response = api_client.post(
            "/assistants/", data=assistant_data, user_type="regular_user"
        )
    ...
    @pytest.mark.blackbox
    @pytest.mark.assistants
    def test_create_assistant_invalid_data(
        self, api_client, assertion_helper, authenticated_user
    ):
        ...
        response = api_client.post(
            "/assistants/", data=invalid_data, user_type="regular_user"
        )
    ...
    def test_get_assistants_list(
        ...
        assertion_helper.assert_success_response(response, 200)
        assertion_helper.assert_response_structure(
            response.json(), ["assistants", "total", "page", "size"]
        )
        assertion_helper.assert_list_response(response.json()["assistants"])

    @pytest.mark.blackbox
    @pytest.mark.assistants
    def test_get_assistants_list_with_filters(
        self, api_client, assertion_helper, authenticated_user
    ):
        ...
        response = api_client.get(
            "/assistants/", params={"status": "active"}, user_type="regular_user"
        )
        assertion_helper.assert_success_response(response, 200)

        # Test with category filter
        response = api_client.get(
            "/assistants/", params={"category": "general"}, user_type="regular_user"
        )
        assertion_helper.assert_success_response(response, 200)

        # Test with pagination
        response = api_client.get(
            "/assistants/", params={"page": 1, "size": 10}, user_type="regular_user"
        )
        assertion_helper.assert_success_response(response, 200)
    ...
    @pytest.mark.blackbox
    @pytest.mark.assistants
    def test_get_assistant_by_id_not_found(
        self, api_client, assertion_helper, authenticated_user
    ):
        ...
        response = api_client.get(
            "/assistants/00000000-0000-0000-0000-000000000000", user_type="regular_user"
        )
    ...
    def test_delete_assistant(self, api_client, assertion_helper, authenticated_user):
        ...
        response = api_client.delete(
            f"/assistants/{assistant_id}", user_type="regular_user"
        )
    ...
    def test_activate_assistant(self, api_client, assertion_helper, test_assistant):
        ...
        assertion_helper.assert_success_response(response, 200)
        assertion_helper.assert_response_structure(
            response.json(), ["id", "name", "is_active"]
        )
    ...
    @pytest.mark.blackbox
    @pytest.mark.assistants
    def test_get_assistant_status_list(
        self, api_client, assertion_helper, authenticated_user
    ):
    ...
    def test_get_default_assistant(
        ...
        if response.status_code == 200:
            assertion_helper.assert_response_structure(
                response.json(), ["id", "name", "description", "system_prompt", "model"]
            )
        else:
            assertion_helper.assert_not_found(response)
    ...
    @pytest.mark.blackbox
    @pytest.mark.assistants
    def test_get_default_assistant_id(
        self, api_client, assertion_helper, authenticated_user
    ):
    ...
    def test_set_default_assistant(self, api_client, assertion_helper, test_assistant):
        ...
        response = api_client.post(
            "/assistants/default/set", data={"assistant_id": assistant_id}
        )

        assertion_helper.assert_success_response(response, 200)
        assertion_helper.assert_response_structure(
            response.json(), ["id", "name", "is_default"]
        )
...
class TestAssistantTools:
    ...
    def test_add_tool_to_assistant(self, api_client, assertion_helper, test_assistant):
        ...
        if tools_response.status_code == 200 and tools_response.json():
            ...
            tool_data = {"tool_id": tool_id, "enabled": True}

            response = api_client.post(
                f"/assistants/{assistant_id}/tools", data=tool_data
            )
    ...
    def test_get_assistant_tool(self, api_client, assertion_helper, test_assistant):
        ...
        if tools_response.status_code == 200 and tools_response.json():
            ...
            assertion_helper.assert_success_response(response, 200)
            assertion_helper.assert_response_structure(
                response.json(), ["id", "name", "description", "enabled"]
            )
        else:
            pytest.skip("No tools available for testing")
    ...
    @pytest.mark.blackbox
    @pytest.mark.assistants
    def test_get_assistant_tool_not_found(
        ...
        response = api_client.get(
            f"/assistants/{assistant_id}/tools/00000000-0000-0000-0000-000000000000"
        )
        assertion_helper.assert_not_found(response)
    ...
    def test_update_assistant_tool(self, api_client, assertion_helper, test_assistant):
        ...
        if tools_response.status_code == 200 and tools_response.json():
            ...
            response = api_client.put(
                f"/assistants/{assistant_id}/tools/{tool_id}", data=update_data
            )
    ...
    @pytest.mark.blackbox
    @pytest.mark.assistants
    def test_remove_tool_from_assistant(
        self, api_client, assertion_helper, test_assistant
    ):
...
class TestAssistantValidation:
    ...
    @pytest.mark.blackbox
    @pytest.mark.assistants
    def test_create_assistant_missing_required_fields(
        self, api_client, assertion_helper, authenticated_user
    ):
        ...
        # Missing name
        invalid_data = {"description": "Test description", "model": "gpt-4"}
    ...
    @pytest.mark.blackbox
    @pytest.mark.assistants
    def test_create_assistant_invalid_model(
        self, api_client, assertion_helper, authenticated_user
    ):
    ...
    @pytest.mark.blackbox
    @pytest.mark.assistants
    def test_create_assistant_invalid_temperature(
        self, api_client, assertion_helper, authenticated_user
    ):
    ...
    @pytest.mark.blackbox
    @pytest.mark.assistants
    def test_create_assistant_invalid_max_tokens(
        self, api_client, assertion_helper, authenticated_user
    ):
    ...
    @pytest.mark.blackbox
    @pytest.mark.assistants
    def test_update_assistant_invalid_data(
        self, api_client, assertion_helper, test_assistant
    ):
